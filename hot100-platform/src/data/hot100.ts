...
export const HOT100: Problem[] = [
  ...
  // ── 链表 ────────────────────────────────────────────────────
  { id: 160, slug: '160_intersection_linked', title: '相交链表', titleEn: 'Intersection of Two Linked Lists', category: '链表', difficulty: 'Easy', tags: ['哈希表', '链表', '双指针'], hasVisualization: true },
  { id: 206, slug: '206_reverse_linked', title: '反转链表', titleEn: 'Reverse Linked List', category: '链表', difficulty: 'Easy', tags: ['链表', '递归'], hasVisualization: true },
  { id: 234, slug: '234_palindrome_linked', title: '回文链表', titleEn: 'Palindrome Linked List', category: '链表', difficulty: 'Easy', tags: ['链表', '递归', '双指针'], hasVisualization: true },
  { id: 141, slug: '141_linked_cycle', title: '环形链表', titleEn: 'Linked List Cycle', category: '链表', difficulty: 'Easy', tags: ['哈希表', '链表', '双指针'], hasVisualization: true },
  { id: 142, slug: '142_linked_cycle_ii', title: '环形链表 II', titleEn: 'Linked List Cycle II', category: '链表', difficulty: 'Medium', tags: ['哈希表', '链表', '双指针'], hasVisualization: true },
  { id: 21, slug: '021_merge_sorted_lists', title: '合并两个有序链表', titleEn: 'Merge Two Sorted Lists', category: '链表', difficulty: 'Easy', tags: ['链表', '递归'], hasVisualization: true },
  ...
  { id: 146, slug: '146_lru_cache', title: 'LRU 缓存', titleEn: 'LRU Cache', category: '链表', difficulty: 'Medium', tags: ['链表', '哈希表'], hasVisualization: true },

  // ── 二叉树 ──────────────────────────────────────────────────
  { id: 94, slug: '094_inorder_traversal', title: '二叉树的中序遍历', titleEn: 'Binary Tree Inorder Traversal', category: '二叉树', difficulty: 'Easy', tags: ['栈', '树', '深度优先'], hasVisualization: true },
  { id: 104, slug: '104_max_depth', title: '二叉树的最大深度', titleEn: 'Maximum Depth of Binary Tree', category: '二叉树', difficulty: 'Easy', tags: ['树', '递归', '广度优先'], hasVisualization: true },
  { id: 226, slug: '226_invert_tree', title: '翻转二叉树', titleEn: 'Invert Binary Tree', category: '二叉树', difficulty: 'Easy', tags: ['树', '深度优先', '广度优先'], hasVisualization: true },
  { id: 101, slug: '101_symmetric_tree', title: '对称二叉树', titleEn: 'Symmetric Tree', category: '二叉树', difficulty: 'Easy', tags: ['树', '深度优先', '广度优先'], hasVisualization: true },
  { id: 543, slug: '543_diameter_tree', title: '二叉树的直径', titleEn: 'Diameter of Binary Tree', category: '二叉树', difficulty: 'Easy', tags: ['树', '深度优先'], hasVisualization: true },
  { id: 102, slug: '102_level_order', title: '二叉树的层序遍历', titleEn: 'Binary Tree Level Order Traversal', category: '二叉树', difficulty: 'Medium', tags: ['树', '广度优先'], hasVisualization: true },
  { id: 108, slug: '108_sorted_to_bst', title: '将有序数组转换为二叉搜索树', titleEn: 'Convert Sorted Array to BST', category: '二叉树', difficulty: 'Easy', tags: ['数组', '分治', '树'], hasVisualization: true },
  { id: 98, slug: '098_validate_bst', title: '验证二叉搜索树', titleEn: 'Validate Binary Search Tree', category: '二叉树', difficulty: 'Medium', tags: ['树', '深度优先', 'BST'], hasVisualization: true },
  { id: 230, slug: '230_kth_smallest', title: 'BST 中第 K 小的元素', titleEn: 'Kth Smallest Element in a BST', category: '二叉树', difficulty: 'Medium', tags: ['树', '深度优先', 'BST'], hasVisualization: true },
  { id: 199, slug: '199_right_side_view', title: '二叉树的右视图', titleEn: 'Binary Tree Right Side View', category: '二叉树', difficulty: 'Medium', tags: ['树', '深度优先', '广度优先'], hasVisualization: true },
  { id: 114, slug: '114_flatten_tree', title: '二叉树展开为链表', titleEn: 'Flatten Binary Tree to Linked List', category: '二叉树', difficulty: 'Medium', tags: ['栈', '树', '深度优先'], hasVisualization: true },
  { id: 105, slug: '105_preorder_inorder', title: '从前序与中序遍历序列构造二叉树', titleEn: 'Construct Binary Tree from Preorder and Inorder', category: '二叉树', difficulty: 'Medium', tags: ['数组', '哈希表', '分治'], hasVisualization: true },
  { id: 437, slug: '437_path_sum_iii', title: '路径总和 III', titleEn: 'Path Sum III', category: '二叉树', difficulty: 'Medium', tags: ['树', '深度优先', '前缀和'], hasVisualization: true },
  { id: 236, slug: '236_lca_binary_tree', title: '二叉树的最近公共祖先', titleEn: 'Lowest Common Ancestor of a Binary Tree', category: '二叉树', difficulty: 'Medium', tags: ['树', '深度优先'], hasVisualization: true },
  { id: 124, slug: '124_max_path_sum', title: '二叉树中的最大路径和', titleEn: 'Binary Tree Maximum Path Sum', category: '二叉树', difficulty: 'Hard', tags: ['动态规划', '树', '深度优先'], hasVisualization: true },
  { id: 297, slug: '297_serialize_tree', title: '二叉树的序列化与反序列化', titleEn: 'Serialize and Deserialize Binary Tree', category: '二叉树', difficulty: 'Hard', tags: ['树', '设计', '字符串'], hasVisualization: true },

  // ── 图论 ────────────────────────────────────────────────────
  { id: 200, slug: '200_num_islands', title: '岛屿数量', titleEn: 'Number of Islands', category: '图论', difficulty: 'Medium', tags: ['深度优先', '广度优先', '并查集'], hasVisualization: true },
  { id: 994, slug: '994_rotting_oranges', title: '腐烂的橘子', titleEn: 'Rotting Oranges', category: '图论', difficulty: 'Medium', tags: ['广度优先'], hasVisualization: true },
  { id: 207, slug: '207_course_schedule', title: '课程表', titleEn: 'Course Schedule', category: '图论', difficulty: 'Medium', tags: ['深度优先', '广度优先', '拓扑排序'], hasVisualization: true },
  { id: 208, slug: '208_implement_trie', title: '实现 Trie（前缀树）', titleEn: 'Implement Trie (Prefix Tree)', category: '图论', difficulty: 'Medium', tags: ['设计', 'Trie'], hasVisualization: true },
  { id: 547, slug: '547_province_number', title: '省份数量', titleEn: 'Number of Provinces', category: '图论', difficulty: 'Medium', tags: ['深度优先', '广度优先', '并查集'], hasVisualization: true },
  { id: 130, slug: '130_surrounded_regions', title: '被围绕的区域', titleEn: 'Surrounded Regions', category: '图论', difficulty: 'Medium', tags: ['深度优先', '广度优先', '并查集'], hasVisualization: true },
  ...
  { id: 51, slug: '051_n_queens', title: 'N 皇后', titleEn: 'N-Queens', category: '回溯', difficulty: 'Hard', tags: ['回溯'], hasVisualization: true },

  // ── 二分查找 ────────────────────────────────────────────────
  { id: 35, slug: '035_search_insert', title: '搜索插入位置', titleEn: 'Search Insert Position', category: '二分查找', difficulty: 'Easy', tags: ['数组', '二分'], hasVisualization: true },
  { id: 74, slug: '074_search_matrix', title: '搜索二维矩阵', titleEn: 'Search a 2D Matrix', category: '二分查找', difficulty: 'Medium', tags: ['数组', '二分', '矩阵'], hasVisualization: true },
  { id: 34, slug: '034_search_range', title: '在排序数组中查找元素的第一个和最后一个位置', titleEn: 'Find First and Last Position', category: '二分查找', difficulty: 'Medium', tags: ['数组', '二分'], hasVisualization: true },
  { id: 33, slug: '033_search_rotated', title: '搜索旋转排序数组', titleEn: 'Search in Rotated Sorted Array', category: '二分查找', difficulty: 'Medium', tags: ['数组', '二分'], hasVisualization: true },
  { id: 153, slug: '153_find_min_rotated', title: '寻找旋转排序数组中的最小值', titleEn: 'Find Minimum in Rotated Sorted Array', category: '二分查找', difficulty: 'Medium', tags: ['数组', '二分'], hasVisualization: true },
  { id: 4, slug: '004_median_arrays', title: '寻找两个正序数组的中位数', titleEn: 'Median of Two Sorted Arrays', category: '二分查找', difficulty: 'Hard', tags: ['数组', '二分', '分治'], hasVisualization: true },
